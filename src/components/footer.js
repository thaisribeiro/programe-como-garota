...
function Footer() {
  ...
  return (
    <div className="footer-container">
      <ul className="horizontal-links" style={{ marginTop: '4.6rem', marginBottom: '1.5rem', position: 'relative', 'zIndex': 10 }}>
      ...
      <div className="direitos-reservados">
        <label>Por Thais Ribeiro</label>
        <label>Todos os direitos reservados © 2019</label>
      </div>
    </div>
  )
}
